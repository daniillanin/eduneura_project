<template>
    ...
    <div v-if="props.tableID">
        ...
        <DataTable :value="rows" :editMode="store.currentUserData?.role == 'user' ? 'null' : 'cell'" @cell-edit-complete="onCellEditComplete" ref="tableElement" stripedRows removableSort scrollable
